...
namespace ChrisConnorBlogAssessment.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,Content,DateAdded,BlogId,Id")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,Content,DateAdded,BlogId,Id")] Comment comment)
        {
            if (ModelState.IsValid)
            {
